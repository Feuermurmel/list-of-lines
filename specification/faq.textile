h1. FAQ: Frequently Answered Questions

- Isn't this section normally called Frequenly _Asked_ Questions? :=
...
- Is the file format called _List-of-Lines_ just so you can use the file extension `.lol`? :=
